...
Public Class CoordinatorRequestOffers
    ...
    Private Sub CompanyOffersWithID(facultyID As Integer)
        ...
        DGVRequest.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells
        DGVRequest.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells

        DGVRequest.Columns("COD_Oferta").HeaderText = "ID de la oferta"
        DGVRequest.Columns("Titulo").HeaderText = "Titulo"
        DGVRequest.Columns("Descripcion").HeaderText = "Descripcion"
        DGVRequest.Columns("Descripcion").DefaultCellStyle.WrapMode = DataGridViewTriState.True
        DGVRequest.Columns("Requisitos").HeaderText = "Requisitos"
        DGVRequest.Columns("Requisitos").DefaultCellStyle.WrapMode = DataGridViewTriState.True
        DGVRequest.Columns("FechaEnvio").HeaderText = "Fecha de envio"
        DGVRequest.Columns("Estado").HeaderText = "Estado de oferta"
        DGVRequest.Columns("FechaInicio").HeaderText = "Inicio"
        DGVRequest.Columns("FechaFin").HeaderText = "Fin"
        DGVRequest.Columns("ID_Facultad").HeaderText = "Facultad"
        DGVRequest.Columns("ID_Empresa").HeaderText = "Empresa"
    End Sub
        ...
        If DGVRequest.SelectedRows.Count > 0 Then
            ...
            Using conn As New SqlConnection(connString)
                ...
                If affectedRows > 0 Then
                    ' Insertando la nueva oferta en la base de datos en la tabla OfertasAprobadas
                    ...
                    cmdInsert.Parameters.AddWithValue("@Estado", selectedRow.Cells("Estado").Value)
                    ...
                    DGVRequest.Rows.Remove(selectedRow)
